...
const Settings = (() => {
  ...
  function _renderCards() {
    ...
    const filtered = query
      ? _models.filter(m => _matchesModelSearch(m, query))
      : _models.slice();
  ...
  // is kept so toggling providers never silently drops it.
  ...
  function _openModalDuplicate(index) {
    ...
    document.getElementById("model-modal-api-format").value = source.api_format || "";
