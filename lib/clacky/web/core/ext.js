...
Clacky.ext = (() => {
  ...
  // workspace, the settings panel — is treated as global chrome: mounts
  // there always show, regardless of which panel file happened to be
  // loading. This is what separates "session UI" from "app chrome" and it
