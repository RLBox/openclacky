...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "settings.models.enterpriseOnly": "Your administrator allows enterprise-managed models only. Personal API keys are disabled.",
      "settings.models.badge.enterpriseManaged": "Enterprise managed",
      ...
      "settings.enterprise.title": "Enterprise license",
      "settings.enterprise.active": "Authorized via enterprise login",
      "settings.enterprise.inactive": "Authorization expired or revoked; contact your administrator",
      "settings.enterprise.unreachable": "Cannot verify authorization; check your enterprise connection",
      "settings.enterprise.permanent": "No expiry",
      "settings.enterprise.devices": "Devices used / limit",
      "settings.enterprise.description": "Managed through enterprise device login. No serial number is required.",
      "settings.enterprise.models.refresh": "Refresh enterprise models",
      "settings.enterprise.models.refreshing": "Refreshing…",
      "settings.enterprise.models.updated": "Updated · {count} models available",
      "settings.enterprise.models.current": "Up to date · {count} models available",
      "settings.enterprise.models.failed": "Refresh failed; the last usable models were kept.",
      ...
      "onboard.enterprise.source.label":    "Enterprise website address",
      "onboard.enterprise.source.placeholder": "https://www.openclacky.com",
      "onboard.enterprise.source.hint":     "Enter the website root address provided by your administrator.",
      "onboard.enterprise.cancel":          "Cancel",
      "onboard.enterprise.continue":        "Continue to login →",
      "onboard.enterprise.success.lead":    "Your enterprise account is connected and its model is ready.",
      "onboard.enterprise.success.restarting": "Enterprise access is ready. OpenClacky is applying the new platform source.",
      "onboard.enterprise.success.model":   "Enterprise model:",
    ...
    zh: {
      ...
      "settings.models.enterpriseOnly": "管理员已设置为仅使用企业模型，个人 API Key 已停用。",
      "settings.models.badge.enterpriseManaged": "企业托管",
      ...
      "settings.enterprise.title": "企业许可证",
      "settings.enterprise.active": "已授权 · 企业设备登录",
      "settings.enterprise.inactive": "授权已失效或被撤销，请联系企业管理员",
      "settings.enterprise.unreachable": "暂时无法验证授权，请检查企业平台连接",
      "settings.enterprise.permanent": "长期有效",
      "settings.enterprise.devices": "已用设备 / 设备上限",
      "settings.enterprise.description": "通过企业设备登录管理授权，无需输入序列号。",
      "settings.enterprise.models.refresh": "刷新企业模型",
      "settings.enterprise.models.refreshing": "正在刷新…",
      "settings.enterprise.models.updated": "已更新 · 可用 {count} 个模型",
      "settings.enterprise.models.current": "已是最新 · 可用 {count} 个模型",
      "settings.enterprise.models.failed": "刷新失败，已保留上次可用模型。",
      ...
      "onboard.enterprise.source.label":    "企业网页地址",
      "onboard.enterprise.source.placeholder": "https://www.openclacky.com",
      "onboard.enterprise.source.hint":     "请输入管理员提供的企业网页根地址。",
      "onboard.enterprise.cancel":          "取消",
      "onboard.enterprise.continue":        "继续登录 →",
      "onboard.enterprise.success.lead":    "企业账号已连接，企业模型已自动配置。",
      "onboard.enterprise.success.restarting": "企业账号已连接，正在应用新的平台源并重启 OpenClacky。",
      "onboard.enterprise.success.model":   "企业模型：",
