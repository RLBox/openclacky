...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "runtime.provider.dynamicHint":        "The actual model and reasoning effort are selected when the session starts.",
      ...
      "onboard.manual.toggle":      "Choose another provider (API or Codex)",
      "onboard.provider.custom":    "Custom",
      "provider.recommended":        "Recommended",
      "provider.name.codex":         "Codex (ChatGPT)",
    ...
    zh: {
      ...
      "runtime.provider.dynamicHint":        "实际模型与推理强度会在会话启动后由运行时提供。",
      ...
      "onboard.manual.toggle":      "选择其他服务商（API 或 Codex）",
