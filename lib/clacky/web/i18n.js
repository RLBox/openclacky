...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "channels.statusMessages.desc":   "Send \"Thinking...\" and completion-summary updates to the chat",
      ...
      "settings.search.desc":              "Free built-in search (DuckDuckGo / Bing) works out of the box. Connect an API provider below for higher-quality results — falls back to built-in if unavailable.",
      "settings.search.provider":          "Provider",
      "settings.search.builtin":           "Built-in (DuckDuckGo / Bing)",
    ...
    zh: {
      ...
      "channels.statusMessages.desc":   "在聊天中发送「Thinking...」「Done」等过程提示",
      ...
      "settings.search.desc":              "内置免费搜索（DuckDuckGo / Bing）开箱即用。在下方接入 API 服务商可获得更高质量的搜索结果，不可用时自动回退到内置引擎。",
      "settings.search.provider":          "服务商",
      "settings.search.builtin":           "内置（DuckDuckGo / Bing）",
