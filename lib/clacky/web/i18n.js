...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      // ── Phases ──
      "phase.no_changes":      "no changes needed",
      ...
      "sidebar.extensions": "Extension Management",
      ...
      // ── Projects ──
      "projects.defaultName": "New Project",
      "projects.create.title": "New Project",
      "projects.create.label": "Project name",
      "projects.create.placeholder": "Project name",
      "projects.create.dirPlaceholder": "Working directory (optional)",
      "projects.create.sourceFolders": "Source folders",
      "projects.create.folderHint": "Add a working folder",
      "projects.create.folderDefaultHint": "If not set, the default working directory ~/clacky_workspace will be used",
      "projects.create.submit": "Create Project",
      "projects.create.colorLabel": "Color",
      "projects.create.iconLabel": "Icon",
      "projects.picker.done": "Done",
      "projects.emptyHint": "No projects yet",
      "projects.noSessions": "No sessions",
      "projects.organize.grouped": "By Project",
      "projects.organize.flat":    "In a flat list",
      "projects.organize.sortLabel":    "Sort by",
      "projects.organize.sortPriority": "Priority",
      "projects.organize.sortRecent":   "Last updated",
      "projects.menu.rename": "Rename",
      "projects.menu.pin": "Pin to top",
      "projects.menu.unpin": "Unpin",
      "projects.menu.edit": "Edit Project",
      "projects.menu.delete": "Delete Project",
      "projects.menu.deleteSessions": "Clear Sessions",
      "projects.edit.title": "Edit Project",
      "projects.edit.submit": "Save",
      "projects.delete.confirm": "Delete project \"{{name}}\"? All sessions in this project will also be deleted.",
      "projects.deleteSessions.confirm": "Clear all sessions in project \"{{name}}\"? The project itself will be kept.",
      "projects.modal.name":         "Project Name",

      // ── Welcome screen ──
      "sessions.new.title":       "Start a new session",
      "sessions.new.title.named": "Hi, {{name}}. Ready to get started?",
      "sessions.new.modelsUnavailable": "Could not load model configuration. Please retry.",
      "sessions.new.subtitle":    "Pick an agent to chat with, then tell it what you'd like to do.",
      ...
      "chat.input.placeholder": "What can I help you with today? @ reference a chat or file, / for skills, Enter to send, Shift + Enter for newline",
      "chat.input.placeholderRunning": "AI is working — you can still send extra info anytime...",
      "chat.input.placeholderMobile": "What can I help you with today?",
      ...
      "chat.file.tooLarge":        "File too large: {{name}} (max {{max}})",
      "chat.file.imageTooLarge":   "Image too large: {{name}} (max {{max}})",
      "chat.file.unsupportedType": "Unsupported image type: {{type}}\nSupported: PNG, JPEG, GIF, WEBP",
      "chat.file.processFailed":   "Image processing failed: {{msg}}",
      "chat.file.uploadFailed":    "Upload failed: {{msg}}",
      ...
      "chat.input.behaviorTitle": "Messages while working",
      "chat.input.interruptDescription": "Stop the current step and accept your message.",
      "chat.input.steerDescription": "Accept your message after the current step.",
      "chat.input.interruptMode": "Interrupt and add",
      "chat.input.steerMode": "Guide current task",
      "chat.input.queued": "Waiting to be received",
      "chat.input.editQueued": "Edit",
      "chat.input.saveQueued": "Save",
      "chat.input.sendQueued": "Send now (interrupt current task)",
      "chat.input.removeQueued": "Remove",
      "chat.interrupted":    "Generation stopped",
      "chat.feedback_hint":  "Or type your own answer below ↓",
      "chat.feedback_submit": "Submit",
      "chat.feedback_other": "Or type your own answer",
      "chat.feedback_recommended": "recommended",
      "chat.feedback_step": "{{cur}} / {{total}}",
      "chat.feedback_back": "Back",
      "chat.feedback_next": "Next",
      "chat.newMessageHint": "New messages ↓",
      "chat.retry":          "Retry",
      "chat.quote.btn":         "Quote",
      "chat.quote.roleUser":     "You",
      "chat.quote.roleAssistant": "Assistant",
      "chat.quote.sig":          "{{role}} · #{{index}}",
      ...
      "chat.empty.title.named": "Hi, {{name}}. Ready to get started?",
      ...
      "sib.dir.current":         "Current workspace",
      "sib.dir.inputPlaceholder": "Type or select a directory path",
      "sib.dir.back":            "Back",
      "sib.dir.forward":         "Forward",
      "sib.dir.refresh":         "Refresh",
      "sib.dir.addFavorite":     "Add to favorites",
      "sib.dir.removeFavorite":  "Remove from favorites",
      "sib.dir.userFavorites":   "My favorites",
      ...
      "sib.dir.showHidden":      "Show hidden files",
      "sib.dir.newFolder":       "New folder",
      "sib.dir.newFolderDefault": "New Folder",
      "sib.dir.mkdirError":      "Failed to create folder: {{msg}}",
      "sib.dir.favorites": "Quick access",
      "sib.dir.places.home": "Home",
      "sib.dir.places.desktop": "Desktop",
      "sib.dir.places.downloads": "Downloads",
      "sib.dir.places.documents": "Documents",
      "sib.dir.drives": "Drives",
      "sib.dir.places.drive": "{{letter}}:",
      "workspace.title":         "Files",
      "workspace.toggleTree":    "Toggle file tree",
      "workspace.backToFiles":   "Back to files",
      "workspace.splitPreview":  "Split preview",
      ...
      "workspace.noResults":    "No matching files",
      ...
      "workspace.fallbackHint":   "This file type can't be previewed here.",
      "workspace.fallbackSubHint": "Please open this file in another application to view it.",
      "workspace.tableTruncated": "Showing the first %{rows} rows only. Use \"Open\" to view the full file.",
      "workspace.open":           "Open",
      "workspace.openDefault":   "Open with default app",
      "workspace.openWith":       "Open with {{app}}",
      "workspace.openWithFailed": "Failed to open file",
      ...
      "changes.save.done":        "Saved",
      "changes.save.failed":      "Save failed",
      "changes.select.all":       "All",
      "changes.select.count":     "{{n}}/{{total}} selected",
      "changes.save.btnN":        "Save {{n}} selected file(s)",
      "changes.save.promptMsg":   "Describe this snapshot",
      "changes.backToList":       "Back to changes",
      "changes.diff.loading":     "Loading diff…",
      "changes.diff.fail":        "Failed to load diff",
      "changes.diff.same":        "No content change in this file.",
      "changes.diff.binary":      "Binary file - line diff not available.",
      "changes.diff.truncated":   "Diff too long - showing first {{n}} lines",
      "changes.restore.title":    "Revert this file's changes",
      "changes.restore.confirm": "Discard?",
      "changes.restore.diffBtn": "Discard changes",
      "changes.restore.doing":   "Reverting…",
      "changes.restore.done":    "Reverted: {{path}}",
      "changes.restore.failed":  "Revert failed",
      "preview.tab":              "Preview",
      "preview.empty.title":      "Start browsing",
      "preview.empty.sub":        "Enter a local file path or localhost address to open the page",
      "preview.address":          "Enter a local file path or localhost address",
      "preview.notFound":         "File not found",
      "preview.unreachable":      "Cannot reach the dev server",
      ...
      "sib.model.empty":         "No models configured",
      "sib.model.loadError":     "Could not load models. Please try again.",
      "sib.model.switchError":   "Failed to switch model: {{message}}",
      "sib.model.switchSubmodelError": "Failed to switch model option: {{message}}",
      "sib.model.unknownError":  "Unknown error",
      ...
      "sib.reasoning.runtimeManaged": "Managed by the agent runtime",
      "sib.reasoning.pending":   "Waiting for runtime",
      "sib.id.label":            "Session file",
      "sib.status.tooltip":      "Current session status",
      "sib.status.idle":         "idle",
      "sib.status.running":      "running",
      "sib.status.error":        "error",
      "sib.status.awaiting_feedback": "waiting",
      ...
      "sib.reasoning.minimal":   "Minimal",
      "sib.reasoning.low":       "Low",
      "sib.reasoning.medium":    "Medium",
      "sib.reasoning.high":      "High",
      "sib.reasoning.xhigh": "XHigh",
      "sib.reasoning.max": "Max",
      "sib.reasoning.ultra": "Ultra",
      "sessions.thinking":      "Thinking…",
      "sessions.default_name":  "Session {{n}}",
      "sessions.group.cron":     "Scheduled Tasks",
      "sessions.group.ext":      "Extensions",
      "sessions.dot.running":          "Working",
      "sessions.dot.awaiting_feedback": "Waiting",
      "sessions.dot.error":            "Failed",
      "sessions.dot.done":             "Just finished",
      "sessions.groupMeta":      "{{n}} sessions",
      "sessions.groupLoading":   "Loading sessions...",
      "sessions.badge.cron":    "Auto",
      "sessions.badge.ext":     "Ext",
      "sessions.badge.channel": "Channel",
      "sessions.badge.coding":  "Coding",
      "sessions.badge.setup":   "Setup",
      "sessions.setup.name":    "Onboard",
      "sessions.setup.browser.name": "🌐 Browser Setup",
      ...
      "sessions.actions.moveToProject": "Move to Project",
      "sessions.actions.removeFromProject": "Remove from Project",
      "sessions.actions.copyId": "Copy Session ID",
      "sessions.actions.copyIdDone": "Session ID copied to clipboard",
      "sessions.moveToProject.newProject": "New Project",
      "sessions.moveToProject.noProjects": "No projects yet",
      ...
      "upgrade.btn.changelog":     "Changelog",
      ...
      "trash.subtitle":            "Files the AI Agent moved to trash across all projects. Recall them back to where they were, or clear the ones you don't need.",
      "trash.refresh":     "Refresh",
      "trash.refresh.tooltip":   "Reload the trash list",
      "trash.emptyOld":    "Empty >7 days",
      "trash.emptyOld.tooltip":  "Permanently delete files older than 7 days",
      "trash.emptyOrphans":"Clean orphans",
      "trash.emptyOrphans.tooltip": "Permanently delete entries whose original project no longer exists",
      "trash.emptyAll":    "Empty all",
      "trash.emptyAll.tooltip":  "Permanently delete all trashed files",
      ...
      // ── Session type filter ──
      "trash.filterAll":              "All",
      "trash.filterCron":             "Scheduled",
      "trash.filterManual":           "Regular",
      "trash.filterAllProjects":      "All Projects",
      "trash.sessionAutoCleanHint":   "The system keeps the most recent 200 sessions; older ones are moved here and permanently deleted after 7 days.",
      ...
      "skills.src.user":            "user",
      "skills.src.project":         "project",
      "skills.src.brand":           "brand",
      "skills.btn.use":             "Use",
      ...
      "skills.editFail":            "Failed to load skill",
      "skills.edit.title":          "Edit skill",
      "skills.edit.name":           "Name",
      "skills.edit.nameHint":       "English slug used as the /command name",
      "skills.edit.nameZh":         "Chinese name",
      "skills.edit.description":    "Description",
      "skills.edit.descriptionZh":  "Chinese description",
      "skills.edit.body":           "Content (Markdown)",
      "skills.edit.editMarkdown":   "Edit Markdown",
      "skills.edit.saveFail":       "Save failed",
      ...
      "channels.statusMessages.label":  "Status messages",
      "channels.statusMessages.desc":   "Agent pushes \"Thinking...\" and completion-summary updates to the chat.",
      "channels.statusMessages.on":     "Status messages on - click to turn off",
      "channels.statusMessages.off":    "Status messages off - click to turn on",
      "channels.processMessages.label": "Process messages",
      "channels.processMessages.desc":  "Agent pushes tool-call narration and file/shell previews to the chat",
      "channels.processMessages.on":    "Process messages on - click to turn off",
      "channels.processMessages.off":   "Process messages off - click to turn on",
      ...
      "extensions.subtitle":      "Install and manage extensions. Add agents, skills, and panels to enhance your workflow.",
      ...
      "extensions.filter.system":    "System",
      "extensions.filter.market":    "Marketplace",
      ...
      "extensions.loadMore":      "Load more",
      "extensions.loadingMore":   "Loading…",
      "extensions.homepage":      "Homepage",
      "extensions.by":            "by ",
      "extensions.installs":      "installs",
      "extensions.verified":            "Verified",
      "extensions.unverified":          "Unverified",
      "extensions.unverifiedBanner":    "This extension has not been verified by the platform. It may contain un-reviewed code or behaviors. Install at your own risk.",
      "extensions.unverifiedInstallWarning": "This extension has not been verified by the platform. It may contain un-reviewed code or behaviors. Install anyway?",
      ...
      "extensions.unit.agents":   "agents",
      "extensions.unit.panel":    "panel",
      "extensions.unit.panels":   "panels",
      ...
      "extensions.action.downloading":     "Downloading",
      "extensions.action.extracting":      "Extracting",
      "extensions.action.verifying":       "Verifying",
      "extensions.action.update":          "Update",
      "extensions.action.updating":        "Updating…",
      "extensions.action.installTimeout":  "Install timed out. Please try again.",
      ...
      "extensions.btn.import":        "Import",
      "extensions.import.tooltip":    "Import extension from a local ZIP package",
      "extensions.import.notZip":     "Please choose a .zip file.",
      "extensions.import.failed":     "Import failed. Please try again.",
      "extensions.newExt.btn":  "New Extension",
      "extensions.newExt.seed": "I want to build a new extension. Help me get started: ask me what the extension should do, then scaffold it and build it out step by step.",
      "ext.refresh_hint":    "Reload Extensions",
      "mcp.loading":              "Loading…",
      ...
      "settings.tabs.data":       "Backup Management",
      ...
      "settings.models.search.placeholder": "Search model / provider / remark / base URL",
      "settings.models.search.noResults":    "No models match your search.",
      ...
      "settings.models.field.apiFormat":  "API Format",
      "settings.models.apiFormat.auto":              "Auto (detect from provider & model)",
      "settings.models.apiFormat.anthropicMessages": "Anthropic Messages API",
      "settings.models.apiFormat.openaiCompletions": "OpenAI Chat Completions",
      "settings.models.apiFormat.openaiResponses":   "OpenAI Responses API",
      ...
      "settings.models.btn.duplicate":     "Duplicate",
      ...
      "settings.models.modal.duplicate":   "Duplicate Model",
      "settings.models.field.provider":    "Provider",
      "settings.models.field.remark":      "Remark",
      "settings.models.field.noVision":    "Model cannot recognize images",
      ...
      "runtime.provider.status.label":       "Connection",
      "runtime.provider.status.checking":    "Checking…",
      "runtime.provider.status.connected":   "Connected",
      "runtime.provider.status.notConnected":"Not connected",
      "runtime.provider.status.idle":        "Not started — starts automatically on first use",
      "runtime.provider.status.starting":    "Starting…",
      "runtime.provider.status.unavailable": "Unavailable — check the runtime dependencies",
      "runtime.provider.status.timeout":     "Login timed out — check again to retry",
      "runtime.provider.connect":            "Connect with ChatGPT",
      "runtime.provider.install":            "Install Codex CLI",
      "runtime.provider.installing":         "Installing Codex CLI…",
      "runtime.provider.recheck":            "Check again",
      "runtime.provider.continue":           "Continue →",
      "runtime.provider.dynamicHint":        "Choose the default ChatGPT model for new conversations. You can still switch models inside a conversation.",
      "runtime.provider.newSessionHint":     "Start a new session to switch between API and agent runtime providers.",
      "runtime.provider.loginFailed":        "Could not start login",
      "runtime.provider.changeKind":         "Remove this card before changing its runtime provider or switching between runtime and API.",
      "runtime.provider.learnMore":          "Provider details",
      ...
      "settings.search.desc":              "Free built-in search (Parallel / DuckDuckGo / Bing) works out of the box. Select an API provider below to use it instead.",
      "settings.search.provider":          "Provider",
      "settings.search.builtin":           "Built-in (Parallel / DuckDuckGo / Bing)",
      "settings.search.key":               "API Key",
      "settings.search.save":              "Save",
      "settings.search.saved":             "Saved",
      "settings.search.test":              "Test",
      "settings.search.testing":           "Testing…",
      "settings.search.ok":                "Search provider works",
      "settings.search.failed":            "Search provider test failed",
      "settings.search.custom":            "Add your own provider by dropping a script into ~/.clacky/searchers/ — see tavily.rb for the interface.",
      ...
      "settings.brand.source.desc":        "Choose the platform source for licenses and marketplace content. Changing it unbinds the current license and removes brand Skills.",
      "settings.brand.source.label":       "Platform Source",
      "settings.brand.source.save":        "Save",
      "settings.brand.source.restore":     "Restore",
      "settings.brand.source.saving":      "Switching…",
      "settings.brand.source.saved":       "Source saved.",
      "settings.brand.source.required":    "Enter a platform source URL.",
      "settings.brand.source.invalid":     "Use an HTTP/HTTPS origin without credentials, a path, query parameters, or a fragment.",
      "settings.brand.source.confirm":     "Changing the platform source will unbind the current license and remove all installed brand Skills. You will need to activate again on the new source. Continue?",
      "settings.brand.source.reconnecting": "Source updated. Reconnecting…",
      "settings.brand.source.reconnectFailed": "The source was saved, but the server is still reconnecting. Refresh this page in a moment.",
      ...
      "onboard.device.success.note":        "During the trial only Gemini 3.8 Flash is available — top up any amount to unlock all frontier models on this same key.",
      "onboard.device.success.btn":         "Start using Clacky →",
      "onboard.manual.toggle":      "Choose another provider (API or ChatGPT)",
      "onboard.provider.custom":    "Custom",
      "provider.recommended":        "Recommended",
      "provider.name.codex":         "ChatGPT",
      ...
      "brand.warning.renewBtn":  "Renew License",
      ...
      "header.owner.tooltip":     "Creator — click to open Creator Center",
      "header.cmdbar.placeholder": "Search sessions…",
      "notify.tooltip.on":         "Task alerts ON — sound + desktop notification (click to mute)",
      "notify.tooltip.off":        "Task alerts OFF — click to enable sound + desktop notification",
      "notify.tooltip.onPending":  "Task alerts ON — sound enabled; allow desktop notifications when the browser prompts",
      "notify.tooltip.onDenied":   "Task alerts ON — sound only (desktop notifications blocked in browser settings)",
      "notify.tooltip.onNoDesktop":"Task alerts ON — sound only (this browser has no desktop notifications)",
      "notify.toast.denied":       "Sound alerts enabled. Desktop notifications are blocked in browser settings.",
      "notify.toast.noDesktop":    "Sound alerts enabled. This browser has no desktop notifications.",
      "notify.desktop.title":      "Task complete",
      "notify.desktop.body":       "A background task finished. Click to open it.",
      "notify.desktop.awaiting.title": "Waiting for your reply",
      "notify.desktop.awaiting.body":  "The agent asked you a question. Click to answer.",
      ...
      "sib.price.tip":        "Cost vs Claude Sonnet 5 (≈ ${{in}} in / ${{out}} out per 1M tokens)",
      ...
      "billing.disclaimer":      "Costs are estimated based on token usage and may differ from your provider's actual bill. If you notice discrepancies, please check your provider's billing dashboard.",
    },
    zh: {
      // ── Phases ──
      "phase.no_changes":      "无需改动",
      ...
      // ── Projects ──
      "projects.defaultName": "新项目",
      "projects.create.title": "新建项目",
      "projects.create.label": "项目名称",
      "projects.create.placeholder": "项目名称",
      "projects.create.sourceFolders": "工作目录",
      "projects.create.folderHint": "添加工作文件夹",
      "projects.create.folderDefaultHint": "不设置时将使用默认工作目录 ~/clacky_workspace",
      "projects.create.submit": "创建项目",
      "projects.create.colorLabel": "颜色",
      "projects.create.iconLabel": "图标",
      "projects.picker.done": "完成",
      "projects.emptyHint": "暂无项目",
      "projects.noSessions": "暂无会话",
      "projects.organize.grouped": "按项目分组",
      "projects.organize.flat":    "在一个列表中",
      "projects.organize.sortLabel":    "排序方式",
      "projects.organize.sortPriority": "优先级",
      "projects.organize.sortRecent":   "最近更新",
      "projects.menu.rename": "重命名",
      "projects.menu.pin": "置顶项目",
      "projects.menu.unpin": "取消置顶项目",
      "projects.menu.edit": "编辑项目",
      "projects.menu.delete": "删除项目",
      "projects.menu.deleteSessions": "清空会话",
      "projects.edit.title": "编辑项目",
      "projects.edit.submit": "保存",
      "projects.delete.confirm": "删除项目「{{name}}」？该项目下的所有会话也将被删除。",
      "projects.deleteSessions.confirm": "清空项目「{{name}}」下的所有会话？项目本身会被保留。",
      "projects.modal.name":         "项目名称",

      // ── Welcome screen ──
      "sessions.new.title":       "开始新会话",
      "sessions.new.title.named": "你好，{{name}}。准备好开始了吗？",
      "sessions.new.modelsUnavailable": "无法加载模型配置，请重试。",
      "sessions.new.subtitle":    "选一个想聊的 Agent，说说你想做什么。",
      ...
      "chat.input.placeholder": "今天帮你做些什么？@ 引用会话或文件，/ 调用技能，Enter 发送，Shift + Enter 换行",
      "chat.input.placeholderRunning": "AI 正在工作，你仍然可以随时补充新信息给它...",
      "chat.input.placeholderMobile": "今天帮你做些什么？",
      ...
      "chat.file.tooLarge":        "文件过大：{{name}}（最大 {{max}}）",
      "chat.file.imageTooLarge":   "图片过大：{{name}}（最大 {{max}}）",
      "chat.file.unsupportedType": "不支持的图片格式：{{type}}\n支持：PNG、JPEG、GIF、WEBP",
      "chat.file.processFailed":   "图片处理失败：{{msg}}",
      "chat.file.uploadFailed":    "上传失败：{{msg}}",
      "chat.done":           "完成 — {{n}} 步，{{cost}}",
      "chat.done.duration":  " · {{duration}}s",
      "chat.done.cache":     "缓存命中 {{rate}}% ({{hits}}/{{total}}) · 复用 {{tokens}} tokens",
      "chat.input.behaviorTitle": "AI 工作时发送消息",
      "chat.input.interruptDescription": "立即停止当前执行，接收新信息",
      "chat.input.steerDescription": "当前步骤结束后，接收新信息",
      "chat.input.interruptMode": "打断并补充",
      "chat.input.steerMode": "引导当前任务",
      "chat.input.queued": "待接收",
      "chat.input.editQueued": "编辑",
      "chat.input.saveQueued": "保存",
      "chat.input.sendQueued": "立即发送（打断当前执行）",
      "chat.input.removeQueued": "撤回",
      "chat.interrupted":    "已停止生成",
      "chat.feedback_hint":  "或在下方输入框自由作答 ↓",
      "chat.feedback_submit": "提交",
      "chat.feedback_other": "或自己填写",
      "chat.feedback_recommended": "推荐",
      "chat.feedback_step": "{{cur}} / {{total}}",
      "chat.feedback_back": "上一题",
      "chat.feedback_next": "下一题",
      "chat.newMessageHint": "有新消息 ↓",
      "chat.retry":          "重试",
      "chat.quote.btn":         "引用",
      "chat.quote.roleUser":     "我",
      "chat.quote.roleAssistant": "助手",
      "chat.quote.sig":          "{{role}} · 第{{index}}条",
      "chat.copy":           "复制",
      "chat.todo.title":     "任务清单",
      "chat.todo.spawn":     "开干",
      ...
      "chat.empty.title.named": "你好，{{name}}。准备好开始了吗？",
      ...
      "sib.dir.current":         "当前工作目录",
      "sib.dir.inputPlaceholder": "输入或选择目录路径",
      "sib.dir.back":            "后退",
      "sib.dir.forward":         "前进",
      "sib.dir.refresh":         "刷新",
      "sib.dir.addFavorite":     "添加到收藏",
      "sib.dir.removeFavorite":  "从收藏中移除",
      "sib.dir.userFavorites":   "我的收藏",
      "sib.dir.loading":         "加载中…",
      "sib.dir.empty":           "空目录",
      "sib.dir.loadError":       "加载失败",
      "sib.dir.confirm":         "确认",
      "sib.dir.cancel":          "取消",
      "sib.dir.showHidden":      "显示隐藏文件",
      "sib.dir.newFolder":       "新建文件夹",
      "sib.dir.newFolderDefault": "新建文件夹",
      "sib.dir.mkdirError":      "新建文件夹失败：{{msg}}",
      "sib.dir.favorites": "快捷访问",
      "sib.dir.places.home": "主目录",
      "sib.dir.places.desktop": "桌面",
      "sib.dir.places.downloads": "下载",
      "sib.dir.places.documents": "文稿",
      "sib.dir.drives": "驱动器",
      "sib.dir.places.drive": "{{letter}}盘",
      "workspace.title":         "文件",
      "workspace.toggleTree":    "切换目录树",
      "workspace.backToFiles":   "返回文件列表",
      "workspace.splitPreview":  "并排预览",
      ...
      "workspace.noResults":     "没有匹配的文件",
      "workspace.error":         "加载文件失败",
      "workspace.downloadFailed": "下载失败",
      "workspace.previewFailed": "文件预览失败",
      "workspace.previewUnsupported": "无法预览此类型文件",
      "workspace.fallbackHint":   "该格式暂不支持在线预览",
      "workspace.fallbackSubHint": "请在其他应用中打开此文件查看",
      "workspace.tableTruncated": "仅显示前 %{rows} 行，点击「打开」查看完整文件",
      "workspace.open":           "打开",
      "workspace.openDefault":   "用默认应用打开",
      "workspace.openWith":       "用 {{app}} 打开",
      "workspace.openWithFailed": "打开文件失败",
      "workspace.download": "下载",
      "workspace.copyPath": "复制路径",
      "workspace.copyRelPath": "复制相对路径",
      "aside.collapse":          "收起面板",
      "aside.expand":            "打开面板",
      "aside.fullscreen":        "全屏预览",
      "aside.exitFullscreen":    "退出全屏",
      "workspace.revealInFinder": "打开所在文件夹",
      "workspace.revealFailed":   "无法打开文件位置",
      "workspace.closeTab":      "关闭",
      "workspace.copyContent":    "复制内容",
      "workspace.copied":         "已复制",
      "workspace.copyFailed":     "复制失败",
      "workspace.saved":          "已保存",
      "workspace.saveFailed":     "保存失败",
      "workspace.dirtyCloseConfirm": "文件有未保存的修改，确定关闭？",
      "changes.tab":              "Git 管理",
      ...
      "changes.save.done":        "已存档",
      "changes.save.failed":      "存档失败",
      "changes.select.all":       "全选",
      "changes.select.count":     "已选 {{n}}/{{total}}",
      "changes.save.btnN":        "存档选中的 {{n}} 个文件",
      "changes.save.promptMsg":   "给这个版本写句说明",
      "changes.backToList":       "返回改动列表",
      "changes.diff.loading":     "正在读取差异…",
      "changes.diff.fail":        "读取差异失败",
      "changes.diff.same":       "这个文件的内容没有变化。",
      "changes.diff.binary":     "二进制文件，无法逐行对比。",
      "changes.diff.truncated":   "差异过大，仅显示前 {{n}} 行",
      "changes.restore.title":    "撤销此文件的改动",
      "changes.restore.confirm": "确认丢弃？",
      "changes.restore.diffBtn":  "撤销改动",
      "changes.restore.doing":    "正在撤销…",
      "changes.restore.done":     "已撤销：{{path}}",
      "changes.restore.failed":   "撤销失败",
      "preview.tab":              "预览",
      "preview.empty.title":      "开始浏览",
      "preview.empty.sub":        "输入本地文件路径或 localhost 地址以打开页面",
      "preview.address":          "输入本地文件路径或 localhost 地址",
      "preview.notFound":         "文件不存在",
      "preview.unreachable":      "无法连接到开发服务器",
      "preview.openExternal":    "在新标签页打开",
      "preview.reload":          "刷新",
      "preview.back":             "后退",
      "preview.forward":          "前进",
      "preview.go":               "前往",
      ...
      "sib.model.empty":         "尚未配置模型",
      "sib.model.loadError":     "模型加载失败，请重试。",
      "sib.model.switchError":   "切换模型失败：{{message}}",
      "sib.model.switchSubmodelError": "切换模型选项失败：{{message}}",
      "sib.model.unknownError":  "未知错误",
      "sib.variant.header":      "快速切换",
      "sib.variant.default":     "默认",
      "sib.signal.tooltip":      "最近一次 LLM 响应延迟",
      "sib.reasoning.tooltip":   "点击调整思考等级",
      "sib.reasoning.runtimeManaged": "由 Agent 运行时管理",
      "sib.reasoning.pending":   "等待运行时",
      "sib.id.label":            "会话文件",
      "sib.status.tooltip":      "当前会话状态",
      "sib.status.idle":         "空闲",
      "sib.status.running":      "运行",
      "sib.status.error":        "错误",
      "sib.status.awaiting_feedback": "等待",
      ...
      "sib.reasoning.minimal":   "极低",
      "sib.reasoning.low":       "低",
      "sib.reasoning.medium":    "中",
      "sib.reasoning.high":      "高",
      "sib.reasoning.xhigh": "超高",
      "sib.reasoning.max": "极高",
      "sib.reasoning.ultra": "最高",
      "sessions.thinking":      "思考中…",
      "sessions.default_name":  "会话 {{n}}",
      "sessions.group.cron":     "定时任务",
      "sessions.group.ext":      "扩展",
      "sessions.dot.running":          "工作中",
      "sessions.dot.awaiting_feedback": "等待中",
      "sessions.dot.error":            "执行失败",
      "sessions.dot.done":             "刚刚完成",
      "sessions.groupMeta":      "{{n}} 个会话",
      "sessions.groupLoading":   "正在加载会话...",
      "sessions.badge.cron":    "定时",
      "sessions.badge.ext":     "扩展",
      "sessions.badge.channel": "频道",
      "sessions.badge.coding":  "Coding",
      "sessions.badge.setup":   "配置",
      "sessions.setup.name":    "个性化引导",
      "sessions.setup.browser.name": "🌐 浏览器配置",
      ...
      "sessions.actions.moveToProject": "移入项目",
      "sessions.actions.removeFromProject": "移出此项目",
      "sessions.actions.copyId": "复制会话 ID",
      "sessions.actions.copyIdDone": "会话 ID 已复制到剪贴板",
      "sessions.moveToProject.newProject": "新建项目",
      "sessions.moveToProject.noProjects": "暂无项目",
      ...
      // ── Creator trash ──
      "trash.title":               "文件召回",
      "trash.subtitle":            "AI Agent 在各个项目里丢进回收站的文件。可以把它们召回到原位置，或彻底清理不再需要的。",
      "trash.refresh":     "刷新",
      "trash.refresh.tooltip":   "重新加载回收站列表",
      "trash.emptyOld":    "清理 >7 天",
      "trash.emptyOld.tooltip":  "永久删除 7 天前的文件",
      "trash.emptyOrphans":"清理孤儿",
      "trash.emptyOrphans.tooltip": "永久删除原始项目目录已不存在的条目",
      "trash.emptyAll":    "全部清空",
      "trash.emptyAll.tooltip":  "永久删除所有回收站文件",
      "trash.empty":       "回收站空空如也。",
      "trash.loading":     "加载回收站…",
      ...
      // ── Session type filter ──
      "trash.filterAll":              "全部",
      "trash.filterCron":             "定时任务",
      "trash.filterManual":           "普通会话",
      "trash.filterAllProjects":      "所有项目",
      "trash.sessionAutoCleanHint":   "系统自动保留最近 200 个会话，超出后自动移入此处，超出 7 天的会话将永久删除。",
      ...
      "skills.editFail":            "加载技能失败",
      "skills.edit.title":          "编辑技能",
      "skills.edit.name":           "名称",
      "skills.edit.nameHint":       "英文标识，同时作为 /命令 名称",
      "skills.edit.nameZh":         "中文名称",
      "skills.edit.description":    "英文描述",
      "skills.edit.descriptionZh":  "中文描述",
      "skills.edit.body":           "内容（Markdown）",
      "skills.edit.editMarkdown":   "编辑 Markdown",
      "skills.edit.saveFail":       "保存失败",
      ...
      "channels.statusMessages.label":  "状态消息",
      "channels.statusMessages.desc":   "Agent 在聊天中推送「Thinking...」「Done」等状态提示。",
      "channels.statusMessages.on":     "状态消息已开启 — 点击关闭",
      "channels.statusMessages.off":    "状态消息已关闭 — 点击开启",
      "channels.processMessages.label": "过程消息",
      "channels.processMessages.desc":  "Agent 在聊天中推送工具调用过程叙述和文件/命令预览。",
      "channels.processMessages.on":    "过程消息已开启 — 点击关闭",
      "channels.processMessages.off":   "过程消息已关闭 — 点击开启",
      ...
      "extensions.subtitle":      "安装和管理扩展，通过 Agent、技能与面板增强工作流。",
      "extensions.searchPlaceholder": "搜索扩展…",
      "extensions.sort.newest":   "最新",
      "extensions.sort.updated":  "最近更新",
      "extensions.sort.downloads": "安装最多",
      "extensions.filter.system":    "系统",
      "extensions.filter.market":    "市场",
      "extensions.filter.all":       "全部",
      "extensions.filter.installed": "已安装",
      "extensions.filter.brand":     "品牌",
      "extensions.empty":         "暂无可用扩展。",
      "extensions.noResults":     "没有匹配的扩展。",
      "extensions.loadFailed":    "无法连接扩展市场。",
      "extensions.loadMore":      "加载更多",
      "extensions.loadingMore":   "加载中…",
      "extensions.homepage":      "主页",
      "extensions.by":            "作者：",
      "extensions.installs":      "次安装",
      "extensions.verified":            "已验证",
      "extensions.unverified":          "未验证",
      "extensions.unverifiedBanner":    "此扩展尚未通过平台审核验证，可能包含未经审查的代码或行为，建议谨慎安装。",
      "extensions.unverifiedInstallWarning": "此扩展尚未通过平台审核验证，可能包含未经审查的代码或行为。确定安装？",
      ...
      "extensions.unit.agents":   "个 Agent",
      "extensions.unit.panel":    "个面板",
      "extensions.unit.panels":   "个面板",
      ...
      "extensions.action.downloading":     "下载中",
      "extensions.action.extracting":      "解压中",
      "extensions.action.verifying":       "校验中",
      "extensions.action.update":          "更新",
      "extensions.action.updating":        "更新中…",
      "extensions.action.installTimeout":  "安装超时，请重试。",
      ...
      "extensions.btn.import":        "导入",
      "extensions.import.tooltip":    "从本地 ZIP 包导入扩展",
      "extensions.import.notZip":     "请选择 .zip 文件。",
      "extensions.import.failed":     "导入失败，请重试。",
      "extensions.newExt.btn":  "创建新扩展",
      "extensions.newExt.seed": "我想开发一个新的扩展。请引导我开始：先问清楚这个扩展要做什么，然后帮我搭好骨架并一步步开发出来。",
      "ext.refresh_hint":    "刷新扩展",
      "mcp.loading":              "加载中…",
      ...
      "settings.models.search.placeholder": "搜索模型 / 服务商 / 备注 / Base URL",
      "settings.models.search.noResults":    "没有匹配的模型。",
      "settings.models.filter.all":         "全部服务商",
      ...
      "settings.models.field.baseurl":    "Base URL",
      "settings.models.field.apikey":     "API Key",
      "settings.models.field.apiFormat":  "API 协议",
      "settings.models.apiFormat.auto":              "自动（根据服务商和模型检测）",
      "settings.models.apiFormat.anthropicMessages": "Anthropic Messages API",
      "settings.models.apiFormat.openaiCompletions": "OpenAI Chat Completions",
      "settings.models.apiFormat.openaiResponses":   "OpenAI Responses API",
      ...
      "settings.models.btn.duplicate":     "复制",
      ...
      "settings.models.modal.duplicate":   "复制模型",
      "settings.models.field.provider":    "供应商",
      "settings.models.field.remark":      "备注",
      "settings.models.field.noVision":    "该模型无法识别图片",
      ...
      "runtime.provider.status.label":       "连接状态",
      "runtime.provider.status.checking":    "正在检测…",
      "runtime.provider.status.connected":   "已连接",
      "runtime.provider.status.notConnected":"未连接",
      "runtime.provider.status.idle":        "尚未启动（首次使用时自动连接）",
      "runtime.provider.status.starting":    "正在启动…",
      "runtime.provider.status.unavailable": "不可用，请检查运行时依赖",
      "runtime.provider.status.timeout":     "登录超时，请重新检测",
      "runtime.provider.connect":            "使用 ChatGPT 登录",
      "runtime.provider.install":            "安装 Codex CLI",
      "runtime.provider.installing":         "正在安装 Codex CLI…",
      "runtime.provider.recheck":            "重新检测",
      "runtime.provider.continue":           "继续 →",
      "runtime.provider.dynamicHint":        "请选择新会话默认使用的 ChatGPT 模型；进入会话后仍可单独切换。",
      "runtime.provider.newSessionHint":     "如需在 API 与 Agent 运行时服务之间切换，请新建会话。",
      "runtime.provider.loginFailed":        "无法发起登录",
      "runtime.provider.changeKind":         "如需更换运行时服务，或在运行时与 API 服务之间切换，请先删除此配置卡。",
      "runtime.provider.learnMore":          "服务详情",
      ...
      "settings.search.desc":              "内置免费搜索（Parallel / DuckDuckGo / Bing）开箱即用；也可在下方接入 API 服务商作为替代。",
      "settings.search.provider":          "服务商",
      "settings.search.builtin":           "内置（Parallel / DuckDuckGo / Bing）",
      "settings.search.key":               "API 密钥",
      "settings.search.save":              "保存",
      "settings.search.saved":             "已保存",
      "settings.search.test":              "测试",
      "settings.search.testing":           "测试中…",
      "settings.search.ok":                "搜索服务商可用",
      "settings.search.failed":            "搜索服务商测试失败",
      "settings.search.custom":            "将脚本放入 ~/.clacky/searchers/ 即可添加自定义服务商，接口规范参见 tavily.rb。",
      ...
      "settings.brand.source.desc":        "选择获取授权和市场内容的平台源。切换后将解绑当前许可证，并删除品牌 Skill。",
      "settings.brand.source.label":       "平台源",
      "settings.brand.source.save":        "保存",
      "settings.brand.source.restore":     "还原",
      "settings.brand.source.saving":      "正在切换…",
      "settings.brand.source.saved":       "平台源已保存。",
      "settings.brand.source.required":    "请输入平台源地址。",
      "settings.brand.source.invalid":     "请填写不含凭据、路径、查询参数或片段的 HTTP/HTTPS Origin。",
      "settings.brand.source.confirm":     "切换平台源将解绑当前许可证，并删除所有已安装的品牌 Skill。切换后需要在新源重新激活，是否继续？",
      "settings.brand.source.reconnecting": "平台源已更新，正在重新连接…",
      "settings.brand.source.reconnectFailed": "平台源已保存，但服务仍在重新连接，请稍后刷新页面。",
      ...
      "onboard.device.success.note":        "试用期内仅可使用 Gemini 3.8 Flash —— 任意金额充值后，同一 Key 立即解锁全部前沿模型。",
      "onboard.device.success.btn":         "开始使用",
      "onboard.manual.toggle":      "选择其他服务商（API 或 ChatGPT）",
      ...
      "notify.tooltip.on":         "任务完成提醒：已开启（声音 + 桌面通知，点击关闭）",
      "notify.tooltip.off":        "任务完成提醒：已关闭（点击开启声音 + 桌面通知）",
      "notify.tooltip.onPending":  "任务完成提醒：已开启声音；请在浏览器弹窗中允许桌面通知",
      "notify.tooltip.onDenied":   "任务完成提醒：仅声音（桌面通知已被浏览器拦截，可在设置中允许）",
      "notify.tooltip.onNoDesktop":"任务完成提醒：仅声音（当前浏览器不支持桌面通知）",
      "notify.toast.denied":       "已开启声音提醒。桌面通知被浏览器拦截，可在设置中允许。",
      "notify.toast.noDesktop":    "已开启声音提醒。当前浏览器不支持桌面通知。",
      "notify.desktop.title":      "任务完成",
      "notify.desktop.body":       "有后台任务已完成，点击打开。",
      "notify.desktop.awaiting.title": "等待你的回答",
      "notify.desktop.awaiting.body":  "Agent 向你提了个问题，点击回答。",

      "header.refresh":           "刷新",
      "header.theme.toDark":      "切换到深色模式",
      "header.theme.toLight":     "切换到浅色模式",
      "share.tooltip":            "分享",
      ...
      "sib.price.tip":        "相对 Claude Sonnet 5 的成本（约 ${{in}} 输入 / ${{out}} 输出 / 百万 token）",
      ...
      "billing.disclaimer":      "费用为估算值，基于 Token 用量和模型定价计算，可能与 API 提供商实际账单有所差异。如有异常，请前往 API 提供商查看实际账单。",
    }
  };
  // ── State ──────────────────────────────────────────────────────────────────
  // On first visit (no saved preference), match the OS/browser language.
  function _detectLang() {
    const saved = localStorage.getItem(STORAGE_KEY);
    if (saved) return TRANSLATIONS[saved] ? saved : DEFAULT_LANG;
  ...
  function applyAll() {
    ...
    document.querySelectorAll("[data-i18n-placeholder]").forEach(el => {
      ...
      el.placeholder = ph;
      // contenteditable composers render their placeholder via CSS :empty::before.
      if (el.isContentEditable) el.setAttribute("data-placeholder", ph);
    });
