...
(function() {
  ...
  async function _populateModelDropdown(sessionId, currentModelId, subInfo) {
    ...
    try {
      ...
      const currentIsRuntime = !!(currentModel && currentModel.runtime_id);
      ...
      ModelPicker.populate(dropdown, {
        ...
        mediaCaps,
        subInfo,
        isSelectable: (m) => currentIsRuntime ? m.id === currentModelId : !m.runtime_id,
        onSelect: (m) => _switchModel(sessionId, m.id, RuntimeProvider.displayModel(m)),
